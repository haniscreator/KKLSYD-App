...
class ItemService {
  /// Fetch items with optional caching
  Future<List<Item>> fetchItems(
    ...
    // ✅ Only read from cache if allowed
    if (useCache && !forceRefresh && prefs.containsKey(dataKey) && isFresh()) {
